var Worlds = {
	categories: {
		easy: [
			{
				briefing: ['Welcome to asteroid TR982-420'],
				size: {
					width: [50, 60],
					depth: [210, 320]
				},
			...
			{
				briefing: ['Welcome to asteroid AE02A-809'],
				size: {
					width: [32, 45],
					depth: [200, 340]
				},
			...
			{
				briefing: ['Welcome to asteroid ZPQ6D-N02'],
				size: {
					width: [45, 60],
					depth: [200, 300]
				},
		...
		normal: [
			{
				briefing: ['Welcome to asteroid GH734-1B2'],
				size: {
					width: [30, 40],
					depth: [300, 425]
				},
			...
			{
				briefing: ['Welcome to asteroid SP425-13K'],
				size: {
					width: [40, 50],
					depth: [300, 425]
				},
			...
			{
				briefing: ['Welcome to asteroid FR153-34R'],
				size: {
					width: [40, 60],
					depth: [200, 360]
				},
			...
			{
				briefing: ['Welcome to asteroid ML876-L01'],
				size: {
					width: [40, 60],
					depth: [180, 300]
				},
			...
			{
				briefing: ['Welcome to asteroid ZT542-21N'],
				size: {
					width: [30, 50],
					depth: [200, 350]
				},
		...
		hard: [
			{
				briefing: ['Welcome to asteroid CR417-13F'],
				size: {
					width: [55, 90],
					depth: [300, 400]
				},
			...
			{
				briefing: ['Welcome to asteroid GS340-20S'],
				size: {
					width: [50, 80],
					depth: [200, 400]
				},
			...
			{
				briefing: ['Welcome to asteroid ZT546-3T1'],
				size: {
					width: [40, 70],
					depth: [200, 350]
				},
