...
export default class PlayerEntity extends DrillEntity {
	...
	preUpdate(time, delta) {
		...
		if (this.moving && !phaserload.player.midMove)
			this.sendMove(phaserload.player.position.x + { UP: 0, DOWN: 0, LEFT: -1, RIGHT: +1 }[this.moving], phaserload.player.position.y + { UP: -1, DOWN: 1, LEFT: 0, RIGHT: 0 }[this.moving]);
