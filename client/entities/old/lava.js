...
phaserload.entities.lava.spread = function (lava) {
	...
	if (pos.x - 1 >= 0 && (!surrounds.left || { purple_monster: 1, red_monster: 1, ground_red: 1 }[surrounds.left])) {
		if (surrounds.left === 'ground_red' && jsUtil.chance(80)) return;
