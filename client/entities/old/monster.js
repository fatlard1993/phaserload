...
phaserload.entities.monster = function (x, y, type) {
	...
	this.animations.add('sleep', Phaser.Animation.generateFrameNames(type + '_monster_sleep', 1, 3), jsUtil.randInt(2, 6), true);
	this.animations.add('awake', Phaser.Animation.generateFrameNames(type + '_monster_awake', 1, 3), jsUtil.randInt(6, 12), true);
};
